...
\usepackage{graphicx}
\usepackage{hyperref}
\newif\ifyaltahasenumitem
\IfFileExists{enumitem.sty}{
    \yaltahasenumitemtrue
    \usepackage{enumitem}
}{
    \yaltahasenumitemfalse
}
\ifyaltahasenumitem
    \setlist{nosep}
\else
...
Le projet consiste à concevoir et implémenter ce jeu en appliquant une
modélisation orientée objet et trois design patterns, dont le
\emph{Modèle-Vue-Contrôleur} imposé par le sujet.
